...
/**
 * =====================================================================
 * Labor 12: Die Bauteil-Fabrik & .circuit Parser
 * =====================================================================
 * 
 * Diese Demonstration zeigt:
 * 1. Phase 1: GateFactory - Factory Pattern für Gatter-Erzeugung
 * 2. Phase 2: .circuit Parser - LogicEngine lädt Dateien
 * 3. Phase 3: Der Halbaddierer - Einfache und elegante Schaltungs-Definition
 * 
 * Vorher (Labor 11):
 *   - Alle Gatter wurden hartcodiert in main.cpp erzeugt
 *   - Verkabelungen wurden manuell geschrieben
 *   - Änderungen erforderten Neukompilierung!
 * 
 * Nachher (Labor 12):
 *   - Schaltungen sind in .circuit Textdateien definiert
 *   - Gleicher C++ Code für alle Schaltungen!
 *   - Änderungen? Nur die Textdatei editieren!
 * 
 * Der Halbaddierer:
 *   A ----\
 *          XOR ---> sum (A XOR B)
...
int main() {
    std::cout << "═══════════════════════════════════════════════════════════════" << std::endl;
    std::cout << "  C++ Digital Simulator - Labor 12" << std::endl;
    std::cout << "  Bauteil-Fabrik & .circuit Parser" << std::endl;
    std::cout << "═══════════════════════════════════════════════════════════════\n" << std::endl;
    ...
    std::cout << "Das Beste: Der C++ Code braucht nicht geändert zu werden!" << std::endl;
    std::cout << "Nur die .circuit Datei muss bearbeitet werden!" << std::endl;
